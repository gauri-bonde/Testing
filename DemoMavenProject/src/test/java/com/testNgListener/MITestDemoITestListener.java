...
@Listeners(com.testNgListener.DemoITestListener.class)
public class MITestDemoITestListener {
	WebDriver driver;
	...
	public void m1()
	{
	        ...
	        if (count <= 2) {
	            // Fail first 2 times
	            Assert.fail("Failing intentionally at invocation " + count);
	        }

	        // Pass for rest
	        System.out.println("Demo passed at invocation " + count);
	    }
